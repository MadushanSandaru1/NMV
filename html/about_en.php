                    ...
                    <div class="container-fluid">
                        <div class="row navbar-header">
                            <a class="navbar-brand" href="../index.php">
                                ...
                                <div class="d-none d-md-inline" style="font-size: 70%;">Sri Nishshankamalla Maha Vidyalaya</div>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <!--<div class="mx-auto d-sm-flex d-block flex-sm-nowrap">-->
                    <div class="container">
                        <ul class="link nav navbar-nav">
                            ...
                            <li class="mx-3 nav-item active"><a class="nav-link" href="../html/about_en.php"><i class="fas fa-info"></i> | ABOUT</a></li>
                            <li class="mx-3 nav-item"><a class="nav-link" href="../html/gallery_en.php"><i class="fas fa-photo-video"></i> | GALLERY</a></li>
                            <li class="mx-3 nav-item"><a class="nav-link" href="../html/contact_en.php"><i class="fas fa-phone"></i> | CONTACT</a></li>
                        </ul>
                ...
                <!--<div class="mx-auto d-sm-flex d-block flex-sm-nowrap">-->
                    <div class="container">
                        <ul class="link nav navbar-nav">
                            ...
                            <li class="mx-3 nav-item active"><a class="nav-link" href="about_en.php"><i class="fas fa-info"></i> | ABOUT</a></li>
                            <li class="mx-3 nav-item"><a class="nav-link" href="gallery_en.php"><i class="fas fa-photo-video"></i> | GALLERY</a></li>
                ...
                <div class="info container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="px-5 py-5">
                                <h2 class="topic">School Motto</h2>
                                <div class="colorYellow col-lg-12 col-md-12 col-sm-12 col-12"></div>
                                <div class="colorGreen col-lg-12 col-md-12 col-sm-12 col-12"></div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="emblem px-5 py-5">
                                <h2 class="topic">School Emblem</h2>
                                <div class="colorYellow col-lg-12 col-md-12 col-sm-12 col-12"></div>
                                <div class="colorGreen col-lg-12 col-md-12 col-sm-12 col-12"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="px-5 py-5">
                                <h2 class="topic">School Anthem</h2>
                                <div class="colorYellow col-lg-12 col-md-12 col-sm-12 col-12"></div>
                                <div class="colorGreen col-lg-12 col-md-12 col-sm-12 col-12"></div>
