                ...
                <!--<div class="mx-auto d-sm-flex d-block flex-sm-nowrap">-->
                    <div class="container">
                        <ul class="link nav navbar-nav">
                            ...
                            <li class="mx-3 nav-item active"><a class="nav-link" href="../html/history_en.php"><i class="fas fa-history"></i> | HISTORY</a></li>
            ...
            <nav class="navbar navbar-expand-sm navbar-dark collapse navbar-collapse" id="myNavbar">
                <!--<div class="mx-auto d-sm-flex d-block flex-sm-nowrap">-->
                    <div class="container">
                        <ul class="link nav navbar-nav">
                            <li class="mx-3 nav-item"><a class="nav-link" href="../index.php"><i class="fas fa-home"></i> | HOME</a></li>
                            <li class="mx-3 nav-item active"><a class="nav-link" href="history_en.php"><i class="fas fa-history"></i> | HISTORY</a></li>
